...
public class PerekamanKTP {
    ...
    public void inputPerekaman() {
        ...
        scrollPane.setBounds(0, 0, 800, 1000);
        scrollPane.getVerticalScrollBar().setUnitIncrement(16); // Kecepatan scroll

        // Set ukuran panel besar untuk membuat scroll aktif
        frame.setPreferredSize(new Dimension(780, 2000));
        ...
        submitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String kewarganegaraan = Controller.getCitizenship(
                        KewarganegaraanGroup.getSelection().getActionCommand(),
                        wargaNegaraAsal);
